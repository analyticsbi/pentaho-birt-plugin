...
public class BIRTContentGenerator extends SimpleContentGenerator {
    ...
    private String reportGeneratedTempLocation;
    ...
    public void createContent() throws Exception {
        ...
        BIRTContentGeneratorUtils properties = new BIRTContentGeneratorUtils();
        Properties prop = properties.getBIRTContentGeneratorConfig();
        
        this.reportGeneratedTempLocation = prop.getProperty("birt.reportGeneratedTempLocation");
        this.viewerURL = prop.getProperty("birt.viewerURL");
        
        RepositoryFile BIRTfile = (RepositoryFile) parameterProviders.get("path").getParameter("file");
        String ExecBIRTFilePath = this.reportGeneratedTempLocation + "/" + BIRTfile.getId() + ".rptdesign";
        ...
        try {
            ...
            response.sendRedirect(this.viewerURL + "?__report=" + BIRTfile.getId() + ".rptdesign&__showtitle=false&username=" + session.getName() + "&userroles=" + roles + "&reportname=" + BIRTfile.getTitle());
        } catch (Exception e) {
            Logger.error(getClass().getName(), e.getMessage());
        }
    }
